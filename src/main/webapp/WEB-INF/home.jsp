...
<%@ page import="com.ptteng.entity.Student" %>
<%@ page import="com.ptteng.util.VocationUtil" %>
...
<div class="main container">
            ...
            <div class="main-c row">
                ...
                <ul class="list-unstyled text-center">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                                <%--<img src="<%=s.getUrl_head()%>">--%>
                                <%--<img  src="http://jns.img.bucket.ks3-cn-beijing.ksyun.com/skill/thumb/1e45c611-cf24-4591-8f81-b84e11e81ff1.JPG">--%>
                            <img src="imges/242424.png">
                            <%
                                String course_type = null;
                                VocationUtil util = new VocationUtil();
                                course_type = util.vocationNameToStringWithType(s.getCourse_type());
                            %>
                            <span><%=s.getStu_name()+"【"+course_type+"】"%></span>
                            <p class="text-left"><%=s.getPerson_introduce()%></p>
                        </div>
                    </li>
                    <%}%>
                </ul>
